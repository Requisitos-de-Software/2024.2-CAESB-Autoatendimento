...
<p align="justify">
&emsp;&emsp;Este documento inclui as verificações utilizada para inspecionar o artefato da comprovação informal. Ao final, são apresentados em detalhes os resultados alcançados por meio dessa inspeção.
</p>
...
<p align="justify">
&emsp;&emsp;A tabela 01 apresenta a lista de Verificação da Comprovação Informal  que foram elaboradas com base no plano de ensino da disciplina e 02 apresenta a verificação.
</p>
...
| **ID** | **Descrição**                                              | **Avaliação** | **Autor**    | **Observações**   |
| ------ | ---------------------------------------------------------- | ------------- | ------------ | ----------------- |
| 01     | O produto atende às expectativas do usuário conforme descrito na etapa de validação? |   Sim       | Letícia Resende | 28/01 versão 1.2  |
| 02     | A descrição em linguagem natural permitiu que os clientes identificassem possíveis problemas na formulação dos requisitos? | Sim | Letícia Resende |28/01 versão 1.2 |
| 03     | Foram utilizados canais adequados (e-mail e redes sociais) para validação e comunicação do projeto?  |  Sim   | Letícia Resende | 28/01 versão 1.2 |
| 04     | A mensagem enviada por e-mail foi estruturada e formal, adequada à natureza técnica do conteúdo? |    Sim  | Letícia Resende | 28/01 versão 1.2 |
| 05     | A comunicação utilizada foi suficiente para alcançar o objetivo de validar o projeto junto aos clientes?  | Sim   | Letícia |28/01 versão 1.2  |
...
| :----: | :--------: | :-----------------------------------------: | :------------------------------------------------: | :----------------------------------------------------: |
|  1.0   | 28/01/2025 | Criação do Documento e Lista de Verificação | [Letícia Resende](https://github.com/LeticiaResende23) |[Leandro de Almeida](https://github.com/leomitx10)| 
