...
|--------|-----------------------------------------------------------------------------------------------------|---------------|----------------|
| 01     | O histórico de versão padronizado? |   Sim  |   Versão 1.6 17/12  |
| 02     | O(s) autores e o(s) revisores para cada artefato?  | Sim   | Versão 1.6 17/12  |
| 03     | Referências bibliograficas e/ou bibliografia em todos os artefatos?   |  Sim |  Versão 1.6 17/12  |
| 04     | As tabelas e imagens possuem legenda e fonte e elas chamadas dentro dos textos?  |  Sim  | Versão 1.6 17/12 |
| 05     | Um texto fazendo uma introdução dos artefatos? |  Sim  |  Versão 1.6 17/12 |
| 06     | O cronograma executado com quem realizou cada artefato/atividade com as datas de íncio e fim da construção e realização do artefato/atividade  |  Sim  | Versão 1.6 17/12  |
| 07     | Ata(s) das reuniões (com data, horário de início e do final, participantes, objetivo, atividades definidas, etc). |  Sim  |     Versão 1.6 17/12  |
| 08     | A gravação da reunião do grupo.   |   Sim   | Versão 1.6 17/12  |
| 09     | Vídeo de apresentação na categoria "não listado" no youtube?  |  Sim    |  Versão 1.6 17/12 |
